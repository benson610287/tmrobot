...
string img_path = "/home/glenn/work/tm_ws/src/tmr_ros2/custom_package/tm_img.jpg";
int num = 0;
...
void SubImg::get_new_image_callback(sensor_msgs::msg::Image::SharedPtr msg){
  try{
    ...
    cout << "image saved: " << img_path << endl;
    num += 1;

    show_pose = true;
    std::cout<<"show robot current joint pose\n";
  }
...
SubImg::SubImg() : Node("test_image_sub"){
  ...
  "techman_image", 1000, std::bind(&SubImg::get_new_image_callback, this, std::placeholders::_1));
